...
// A dictionary of nodes that model the story's directed graph
let storyNodes: [Int : Node] = [
    ...
    10 : Node(id: 10,
              ...
              edges: [
                ...
                Edge(destinationId: 17,
                     prompt: "*If you decide to fight the squid with your spear gun, hoping to scare it off, turn to page 17.*")
    ...
    32 : Node(id: 32,
              ...
              edges: [
                ...
                Edge(destinationId: 47,
                     prompt: "*If you go aboard the Greek ship, turn to page 47.*")
    ...
    84 : Node(id: 84,
              paragraphs: [
                ...
                "It is their world, but you are wiling to help them with the planning for the overthrow of the king. You want no real part in the revolt.",
    ...
    90 : Node(id: 90,
              paragraphs: [
                ...
                "Then you are on the planet Ager where the Atlanteans came from. It's a world of fantastic shapes and strange plants. The city gleams like a thousand searchlights. The shapes that must be their buildings are pure light pulsing with energy. Nothing is hard or sharp. Everything is light. You see no people, just forms of brighter light that move. Suddenly, some of the moving forms change into Atlanteans.",
    ...
    108 : Node(id: 108,
               paragraphs: [
                ...
                "Suddenly the door bursts open. Three guards armed with special weapons rush in. They fire the weapons and in a flash of brilliant light you and your companions are vaporized.",
    ...
    114 : Node(id: 114,
               paragraphs: [
                ...
                "With everyone worried about the sea crashing in, no one will notice you if you try to escape. You run down a long, little–used corridor that leads to the sea. The exit door is heavy and rusty from lack of use. You push with all your might, and finallv it swings open into an airlock to the open water. You push the emergency release button and shoot out into the water. The *Seeker* is where you left it, and once inside, you head for the surface where the *Maray* waits for you.",
